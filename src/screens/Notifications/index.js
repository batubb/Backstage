...
import { View, Dimensions, ScrollView, RefreshControl, Switch } from 'react-native';
...
class Notifications extends Component {
    ...
    setSwitchs = () => {
        ...
        if (typeof Store.user.notifications === 'undefined') {
            return this.setState({ pauseAll: false, videos: true, likes: true, roomActivities: true });
        }

        if (Store.user.notifications.videos || typeof Store.user.notifications.videos === 'undefined') {
            pauseAll = false;
            this.setState({ videos: true });
        }

        if (Store.user.notifications.likes || typeof Store.user.notifications.likes === 'undefined') {
            pauseAll = false;
            this.setState({ likes: true });
        }

        if (Store.user.notifications.roomActivities || typeof Store.user.notifications.roomActivities === 'undefined') {
            pauseAll = false;
