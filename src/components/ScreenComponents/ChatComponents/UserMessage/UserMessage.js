...
export default function UserMessage(props) {
  ...
  const isMyMessage = message._sender.userId === sendbird.currentUser.userId;
    ...
    <TouchableOpacity
      ...
      <View style={style.profileImageContainer}>
        {!message.hasSameSenderAbove && (
          <Image
            source={{uri: message._sender.profileUrl}}
      ...
      <View
        ...
        {!message.hasSameSenderAbove && (
          <Text style={style.nickname}>{message._sender.nickname}</Text>
        )}
        <View
          style={{
            ...style.messageBubble,
